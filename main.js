...
const stress = document.querySelectorAll(".stress");
const health = document.querySelectorAll(".health");
const beard = document.querySelectorAll(".beard");
...
tabs.forEach((tab) => {
  tab.addEventListener("click", () => {
    ...
    } else if (tabval == "stress") {
      stress.forEach((item) => {
        item.style.display = "block";
      });
    } else if (tabval == "health") {
      health.forEach((item) => {
        item.style.display = "block";
      });
    } else if (tabval == "beard") {
        beard.forEach((item) => {
          item.style.display = "block";
        });
      } else if (tabval == "beauty") {
        beauty.forEach((item) => {
          item.style.display = "block";
        });
    } else {
